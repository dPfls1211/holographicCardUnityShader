Shader "Custom/butterflyWing"
{
	Properties
	{
		...
		_EdgeLength("Edge length", Range(0,250)) = 100
		_XAmplitude("AmplitudeX",Range(0,5)) = 4.7
		_YAmplitude("AmplitudeY",Range(0,5)) = 1.9
		_YFrequency("YFrequency",Range(1,10)) = 2.7
